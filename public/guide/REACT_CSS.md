...
|--------|:-------------------------------------------------:|-----------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------|
| 성능   | Pure CSS                                          | CSS in JS ( 서능에 좋지는 않음 제컴파일 되어야함 )                          | Pure CSS( 미리 정해진 클래스 이름들을 조립) -> 사용법을 익혀야 함                                              |
| 활용성 | AnyWhere                                          | React, React-Native                                                         | AnyWhere                                                                                                       |
| 강점   | 고립성 /독립성, 순수 CSS, -> 입문자에게 제일 좋음 | 고립성/독립성, Javascript를 통한 편의성  -> 비지니스 로직과 스타일이 뒤엉킴 | 잘 정의된 디자인 시스템,  클래스 이름 창작의 괴로움이 없음,  태그와 스타일을 함꼐! -> 다소 난잡해 보일 수 있음 |  
